...
fizzbuzz x = if mod x 3 == 0 && mod x 5 == 0 then "FizzBuzz" else if mod x 3 == 0 then "Fizz" else if mod x 5 == 0 then "Buzz" else ""
...
myGcd n 0 = n
myGcd 0 m = m
myGcd n m = if n > m then myGcd (n-m) m else myGcd n (m-n)
...
-- if div a 2 == 0 && div b 2 == 0 then EQ else if div a 2 /= 0 && div b 2 /= 0 then EQ else if div a 2 == 0 then LT else if div b 2 == 0 then GT else compare a b
...
hassuMinimi a b = hassuMinimi' (hassuCompare a b) a b

hassuMinimi' LT a b = a
hassuMinimi' GT a b = b
hassuMinimi' EQ a b = a
...
pyramidi n = pyramidi' 0 n

pyramidi' z 0 = show z
pyramidi' z n = show z ++ "," ++ pyramidi' (z+1) (n-1) ++ "," ++ show z  
...
nextPrime n = if isPrime n == True then n else nextPrime (n+1) 
